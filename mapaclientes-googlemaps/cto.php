        ...
        function initMap() {
            ...
            map.addListener('click', (event) => {
                ...
                currentMarker = new google.maps.Marker({
                    ...
                    map: map,
                    icon: {
                            url: 'images/green-icon.png', // Caminho para o seu ícone personalizado
                            scaledSize: new google.maps.Size(30, 30), // Tamanho do ícone (opcional)
                            origin: new google.maps.Point(0, 0), // Posição inicial do ícone (opcional)
                            anchor: new google.maps.Point(15, 15) // Onde o ícone será ancorado (opcional)
                        },
                ...
                // Encontra o marcador mais próximo
                let nearestMarker = null;
                let shortestDistance = Infinity;
                ctoLocations.forEach(location => {
                    const distance = google.maps.geometry.spherical.computeDistanceBetween(clickedLocation, new google.maps.LatLng(location.lat, location.lng));
                    if (distance < shortestDistance) {
                        shortestDistance = distance;
                        nearestMarker = location.marker;
                    }
                });
                ...
                if (nearestMarker) {
                    ...
                    directionsService.route(request, (result, status) => {
                        if (status === google.maps.DirectionsStatus.OK) {
                            ...
                            // Exibe a distância estimado da rota
